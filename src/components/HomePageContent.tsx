...
export default function HomePageContent({ locale, translations }: HomePageContentProps) {
            ...
            <div className="lg:col-span-7 flex flex-col justify-center space-y-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                ...
                <div className="flex flex-col justify-center">
                  <p className="text-sm text-marketing-textSecondary">{t.hero.downloadText}</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-center space-y-6">
              ...
              <div className="bg-marketing-cardBg rounded-lg p-6 shadow-sm border border-marketing-border">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="font-medium text-marketing-foreground">{t.howItWorks.section1.example.title}</span>
                </div>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div className="bg-marketing-cardBg rounded-2xl p-6 shadow-sm hover:shadow-lg transition-shadow">
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-xl font-bold text-marketing-foreground">{t.beyondTasks.features[0].title}</h3>
              </div>
            ...
            <div className="bg-marketing-cardBg rounded-2xl p-6 shadow-sm hover:shadow-lg transition-shadow">
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-xl font-bold text-marketing-foreground">{t.beyondTasks.features[1].title}</h3>
              </div>
              <p className="text-marketing-textSecondary">
            ...
            <div className="bg-marketing-cardBg rounded-2xl p-6 shadow-sm hover:shadow-lg transition-shadow">
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-xl font-bold text-marketing-foreground">{t.beyondTasks.features[2].title}</h3>
              </div>
              <p className="text-marketing-textSecondary">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid gap-8 md:grid-cols-3 max-w-4xl mx-auto">
            ...
            <div className="bg-marketing-cardBg rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all border border-marketing-border">
              ...
              <h3 className="text-xl font-bold text-marketing-foreground mb-4 text-center">{t.cloudSync.features[0].title}</h3>
            ...
            <div className="bg-marketing-cardBg rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all border border-marketing-border">
              ...
              <h3 className="text-xl font-bold text-marketing-foreground mb-4 text-center">{t.cloudSync.features[1].title}</h3>
              <p className="text-marketing-textSecondary text-center">
            ...
            <div className="bg-marketing-cardBg rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all border border-marketing-border">
              ...
              <h3 className="text-xl font-bold text-marketing-foreground mb-4 text-center">{t.cloudSync.features[2].title}</h3>
              <p className="text-marketing-textSecondary text-center">
        ...
        <div className="container mx-auto px-4 text-center md:px-6 relative">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-8">
            ...
            <div className="text-center">
              <p className="text-sm text-marketing-textSecondary">{t.finalCta.trial}</p>
              <p className="text-xs text-marketing-textSecondary mt-1">{t.finalCta.users.replace('{count}', stats.finalCta.find(s => s.labelKey === 'stats.activeUsers')?.value || '500+')}</p>
            </div>
          </div>
