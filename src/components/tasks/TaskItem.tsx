...
export default function TaskItem({
  ...
  if (compact) {
    return (
      <>
        <div
          className="mb-2 rounded-xl overflow-hidden shadow-sm bg-white"
          style={{
        ...
        >
          <div
            className="flex items-center py-3 px-4 min-h-[56px] cursor-pointer hover:bg-gray-50 transition-colors"
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                borderColor: isCompleted ? statusConfig.color : '#D1D5DB'
              }}
            >
              {isCompleted ? (
                <CheckCircle className="w-[18px] h-[18px]" style={{ color: statusConfig.color }} />
              ) : (
                <Circle className="w-[18px] h-[18px] text-gray-400" />
              )}
            </button>
              ...
              {showActionButtons ? (
                ...
                <>
                  <button
                    ...
                    className="w-6 h-6 rounded-xl bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="w-6 h-6 rounded-xl bg-red-100 hover:bg-red-200 flex items-center justify-center transition-colors"
                  >
  ...
  return (
    <>
      <div
        className={`
          bg-white rounded-xl border border-gray-200 overflow-hidden mb-2 shadow-sm
        ...
        <div className="flex items-start p-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap gap-2 mb-2">
              ...
              {/* Subtasks progress */}
              {hasSubtasks && (
                <span className="inline-flex items-center px-2 py-1 rounded-xl text-xs font-medium bg-gray-100 text-gray-600 gap-1">
          ...
          {showActionButtons && (
            <div className="flex flex-col gap-2 ml-3">
              <button
                ...
                className="w-8 h-8 rounded-2xl bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors"
              >
              ...
              <button
                ...
                className="w-8 h-8 rounded-2xl bg-red-100 hover:bg-red-200 flex items-center justify-center transition-colors"
              >
