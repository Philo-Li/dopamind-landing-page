          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid gap-6 md:grid-cols-3">
              <div className="flex flex-col items-center rounded-lg bg-white p-6 shadow-sm">
                ...
                <p className="text-xs text-muted-foreground mt-1">{t.support.contact.email.response}</p>
              </div>
              <div className="flex flex-col items-center rounded-lg bg-white p-6 shadow-sm">
            ...
            {/* Community Links */}
            <div className="mt-8">
              <h3 className="text-xl font-semibold text-center text-foreground mb-6">{t.footer.sections.community}</h3>
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              ...
              <div className="border border-gray-200 rounded-lg">
                ...
                <div className="p-6">
                  <p className="text-muted-foreground">FAQ 内容将根据具体需求添加...</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid gap-6 md:grid-cols-3 max-w-4xl mx-auto">
              <a href="#" className="block p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-sm text-muted-foreground">{t.support.guides.quickStart.description}</p>
              </a>
              <a href="#" className="block p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <h3 className="text-lg font-semibold text-primary mb-2">{t.support.guides.aiCoach.title}</h3>
                <p className="text-sm text-muted-foreground">{t.support.guides.aiCoach.description}</p>
              </a>
              <a href="#" className="block p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <h3 className="text-lg font-semibold text-primary mb-2">{t.support.guides.focus.title}</h3>
                <p className="text-sm text-muted-foreground">{t.support.guides.focus.description}</p>
              </a>
            </div>
          </div>
        </section>
