...
export default function HomePage() {
  ...
  // 尝试不同的圆角大小
  // const logoClassName = "rounded-lg"; // 大圆角 (8px)
  // const logoClassName = "rounded-md"; // 中等圆角 (6px)
  // const logoClassName = "rounded-xl"; // 更大圆角 (12px)
  // const logoClassName = "rounded-full"; // 完全圆形
  const logoClassName = "rounded-[8px]"; // 自定义 10px
...
<Image 
  ...
  width={32}
  height={32}
  className={logoClassName} // 应用你选择的 class
/>
      ...
      <header className="sticky top-0 z-50 w-full border-b border-gray-200 bg-white/80 backdrop-blur-md">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
          <a href="#" className="flex items-center gap-2">
            <Image 
              src="/dopamind-logo.png" // 确保图片放在 public 文件夹下
              alt="Dopamind Logo" 
              width={32}  // Logo 的宽度
              height={32} // Logo 的高度
              className={logoClassName} // ✨ 魔法就在这里！✨
            />
